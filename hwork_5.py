...
print('Команды для ввода:', 'p - выводит имя человека по номеру документа, которому он принадлежит',
 's – выводит номер полки по номеру документа, на которой он находится', 'l - выводит список всех документов',
 'a – добавит новый документ в каталог и в перечень полок',  'd – удаляет документ из каталога и из перечня полок', 
 'm – переместит документ с текущей полки на целевую', 'as - добавит новую полку', sep='\n')
